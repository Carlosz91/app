...
class Vehiculo(db.Model):
    ...
    hora = db.Column(db.Time, default=datetime.now().time())  # Usa Time si solo te interesa la hora
    hora_finalizacion = db.Column(db.Time)  # Nueva columna para hora de finalización
